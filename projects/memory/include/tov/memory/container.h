...
namespace tov
{
    ...
    public:
        ...
        auto end() { return Iterator{ &this->data()[N] }; }
    ...
    struct Container<T, N>::Iterator
    {
        ...
        friend auto operator+(difference_type n, const Iterator j) -> Iterator
        {
        ...
        std::add_const_t<reference> operator*() const { return *mPtr; }

        pointer operator->() { return mPtr; }
        std::add_const_t<pointer> operator->() const { return mPtr; }
